...
from alsa import crack_train, crack_main
...
def train(
    ...
    if not quiet:
        ...
        for target_list, name in zip((training_list, validation_list), ("Training", "Validation")):
    ...
    relevant_input_params = json.dumps(dict(
    epochs=epochs,
...
def predict(
    ...
    area_shp_file_path: Path=typer.Option(..., exists=True, file_okay=True, dir_okay=False),
    unet_weights_path: Path=typer.Option(..., exists=True, file_okay=True, dir_okay=False),
